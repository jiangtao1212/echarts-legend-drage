<template>
  <div class='echarts-drag-containter'>
    ...
    <div class="content">
      ...
      <Echarts id="echarts-container" :option="dataAbout.option" :legendShowData="dataAbout.legendShowData"
...
const update = (data: Array<any>) => {
  ...
  packageLegendShowData(data);
  packageSeriesOpacityData(data);
  packageSeriesyAxisIndexData(data);
  console.groupEnd();
}

// 组装legendShowData --- 各个legend的显示状态
const packageLegendShowData = (data: Array<any>) => {
